...
const ExclusiveOffer = () => {
    return (
        <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20pb-30'>
...
{exclusiveOffers.map((item)=>(
   ...
   <button className='flex items-center gap-2 font-medium cursor-pointer mt-4 mb-5'>
    View Offers
    <img src={assets.arrowIcon} alt="arrow-icons" className='invert group-hover:translate-x-2 transition-all'/>
   </button>
    </div>
))}
</div>
