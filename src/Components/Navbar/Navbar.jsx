...
if (loading) {
  ...
  return (
    ...
    return (
            ...
            <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-25 transition-all duration-500 z-50 ${isScrolled ? "bg-white shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4 " : "py-3 md:py-4 "} ${notHome && "bg-[#0284C7]"}`}>
  ...
  <MenuItems
    modal={false}
    transition
    className="absolute right-0 z-50 mt-2 md:w-[350px] w-[300px] rigin-top-right rounded-sm p-1 shadow-xl border border-white/20 ring-1 ring-black/5 transition data-closed:scale-95 data-closed:transform data-closed:opacity-0 data-enter:duration-100 data-enter:ease-out data-leave:duration-75 data-leave:ease-in focus:outline-none bg-white/90 text-[#121420]"
  >
    <div className="p-2">
      <MenuItem>
      <div className="flex items-center justify-between pb-2">
